...
If you find a security vulnerability in pykawa, please report it through [GitHub's private vulnerability reporting](https://github.com/dangilman/pykawa/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact gilmanda@uchicago.edu for details.
